...
const passwordChangeHandler =(e)=>{
    ...
    const submitHandler = async(e)=>{
      ...
      if(!isLogin){ 
        ...
        let url;
        if(isLogin){
            url='https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBwZxIncN73B4Hg38ZKjieEpqPAtYIRxFA';
        }else{
            url='https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBwZxIncN73B4Hg38ZKjieEpqPAtYIRxFA';
        }
